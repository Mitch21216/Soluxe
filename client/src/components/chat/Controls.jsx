      ...
      <Box style={{ display: "flex", }}>
        <Box style={{ display: "flex", marginLeft: "10px", marginBottom: "10px", marginTop: "-5px", }}>
          <Button className={classes.reverse2}>
            <a style={{ outline: "none", }} href="https://x.com/crusade_gg" target="_blank" rel="noreferrer" alt="Twitter">
          ...
          <Button className={classes.reverse2}>
            <a style={{ outline: "none", }} href="https://discord.gg/KHqpzZ3MCb" target="_blank" rel="noreferrer" alt="Discord">
          ...
          <Button className={classes.reverse2}>
            <Tooltip
              ...
              placement="top"
            >
              <a style={{ outline: "none", }} href="https://discord.gg/Gxv6eTtH2M" target="_blank" rel="noreferrer" alt="Support">
