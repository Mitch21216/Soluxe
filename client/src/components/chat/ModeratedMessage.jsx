            ...
            <Box>
              {isAuthenticated && user ? (
                <Box onClick={handleLeftClick} className="username">
                  ...
                  {message.user.rank === 6 && <span className="staff">STAFF</span>}
                  {message.user.rank === 5 && <span className="mod">MOD</span>}
                  {message.user.rank === 4 && <span className="vip">VIP</span>}
                  {message.user.rank === 3 && <span className="og">OG</span>}
                  {message.user.rank === 2 && <span className="content-creator">CONTENT CREATOR</span>}
