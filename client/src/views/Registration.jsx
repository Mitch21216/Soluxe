        ...
        {!isLoginFields && !forgotPassword ? (
          <Container className={classes.container}>
            <Box className={classes.inputs}>
              <span style={{ color: "#e0e0e0", fontSize: "20px", fontFamily: "Rubik", marginLeft: "3px", marginBottom: "10px" }}>Create an Account</span>
              <TextField
                name="email"
                type="email"
                variant="outlined"
            ...
            {sent ? <ReCAPTCHA
              className={classes.captchaRegister}
            ...
            <span>
              Crusade is protected by reCaptcha.
          ...
          isLoginFields && !forgotPassword ? (
            <Container className={classes.container}>
              <Box className={classes.inputs}>
                <span style={{ color: "#e0e0e0", fontSize: "20px", fontFamily: "Rubik", marginLeft: "3px", marginBottom: "10px" }}>Sign In</span>
                <TextField
                  name="email"
                  variant="outlined"
                  placeholder="Email*"
              ...
              {sent ? <ReCAPTCHA
                className={classes.captchaLogin}
                onChange={reCaptchaOnChange}
                sitekey={RECAPTCHA_SITE_KEY}
              /> : null}
              <Button
